    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Domain 1 Threats, Attacks, and Vulnerabilities", 1 });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name", "SubjectId" },
                values: new object[] { 2, "Domain 2 Architecture and Design", 1 });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name", "SubjectId" },
                values: new object[] { 3, "Domain 3 Implementation", 1 });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name", "SubjectId" },
                values: new object[] { 4, "Domain 4 Operations and Incident Response", 1 });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name", "SubjectId" },
                values: new object[] { 5, "Domain 5 Governance, Risk, and Compliance", 1 });
