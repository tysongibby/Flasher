    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 7, false, 7, 3, 2 });
            ...
            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "AnsweredCorrectly", "FlashcardId", "Number", "TestId" },
                values: new object[] { 2, false, 2, 2, 1 });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "AnsweredCorrectly", "FlashcardId", "Number", "TestId" },
                values: new object[] { 3, false, 3, 3, 1 });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "AnsweredCorrectly", "FlashcardId", "Number", "TestId" },
                values: new object[] { 4, false, 4, 4, 1 });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "AnsweredCorrectly", "FlashcardId", "Number", "TestId" },
                values: new object[] { 5, false, 5, 1, 2 });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "AnsweredCorrectly", "FlashcardId", "Number", "TestId" },
                values: new object[] { 6, false, 6, 2, 2 });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "Id", "AnsweredCorrectly", "FlashcardId", "Number", "TestId" },
                values: new object[] { 8, false, 8, 4, 2 });
